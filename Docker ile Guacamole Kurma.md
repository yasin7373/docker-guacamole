...
### **1. Docker Kurulumu Yapıyoruz** {#docker-kurulumu-yapıyoruz}
...
### **2. Guacamole ve PostgreSQL için Docker Compose Dosyası Oluşturuyoruz** {#guacamole-ve-postgresql-için-docker-compose-dosyası-oluşturuyoruz}
...
### **3. Docker Servislerini Çalıştırıyoruz** {#docker-servislerini-çalıştırıyoruz}
...
### **4. PostgreSQL için Veritabanını Yapılandırıyoruz** {#postgresql-için-veritabanını-yapılandırıyoruz}
...
Artık Guacamole' tarayıcımızdan erişebiliriz. (*localhost *yerine
...
![](Pictures/10000000000004000000014ACC080397C583464C.png){width="10.6665in"
height="3.4374in"}
...
![](Pictures/1000000000000400000003FAC8810FB26F2F8C09.png){width="10.6665in"
height="10.6043in"}
...
![](Pictures/1000000000000400000000E77638B453E9989134.png){width="10.6665in"
height="2.4063in"}
![](Pictures/1000000000000400000000D4AD5D70BEC6766F81.png){width="10.6665in"
height="2.2083in"}
